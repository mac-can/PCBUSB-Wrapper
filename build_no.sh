...
echo " *  CAN Interface API, Version 3 (for PEAK-System PCAN-USB Interfaces)" >> Sources/build_no.h
echo " *" >> Sources/build_no.h
echo " *  Copyright (c) 2012-2023 Uwe Vogt, UV Software, Berlin (info@mac-can.com)" >> Sources/build_no.h
echo " *  All rights reserved." >> Sources/build_no.h
echo " *" >> Sources/build_no.h
echo " *  This file is part of PCBUSB-Wrapper." >> Sources/build_no.h
echo " *" >> Sources/build_no.h
echo " *  PCBUSB-Wrapper is dual-licensed under the BSD 2-Clause \"Simplified\" License" >> Sources/build_no.h
echo " *  and under the GNU General Public License v3.0 (or any later version). You can" >> Sources/build_no.h
echo " *  choose between one of them if you use PCBUSB-Wrapper in whole or in part." >> Sources/build_no.h
echo " *" >> Sources/build_no.h
...
echo " *" >> Sources/build_no.h
echo " *  PCBUSB-Wrapper IS PROVIDED BY THE COPYRIGHT HOLDERS AND CONTRIBUTORS \"AS IS\"" >> Sources/build_no.h
...
echo " *  OF PCBUSB-Wrapper, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGE." >> Sources/build_no.h
echo " *" >> Sources/build_no.h
echo " *  GNU General Public License v3.0 or later:" >> Sources/build_no.h
echo " *  PCBUSB-Wrapper is free software : you can redistribute it and/or modify" >> Sources/build_no.h
...
echo " *" >> Sources/build_no.h
echo " *  PCBUSB-Wrapper is distributed in the hope that it will be useful," >> Sources/build_no.h
...
echo " *  along with PCBUSB-Wrapper.  If not, see <http://www.gnu.org/licenses/>." >> Sources/build_no.h
echo " */" >> Sources/build_no.h
